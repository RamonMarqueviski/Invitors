  ...
  async gerarXLSX(req, res) {
    ...
    if (!competicao) {
      ...
      const [results, metadata] = await sequelize.query(
        'select a."nome" as name,a."cpf" as MemberId,cat."nome" as Event,(select "cpf" as cpf2 from "Atletas" where id = cca."atletaId2") as PartnerId, a."dataNascimento" as DoB ,cat."paid" as Paid,(select "nome" from "Clubes" where id = a."clubeId") as Club  from "categoriasCompeticoes" cc ' +
